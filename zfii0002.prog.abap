************************************************************************
* Projeto            : S4/HANA 1511 FPS02 PROJETO SAPIENS              *
* Titulo do Programa : Mensal de pneus sucateados                      *
* Transação          : ZFIXXXXX                                        *
* Descrição          : Mensal de pneus sucateados                      *
*                                                                      *
*----------------------------------------------------------------------*
* Autor: Edmilson Nascimento                                           *
* Data : 20/12/2016                                                    *
*----------------------------------------------------------------------*
...
*--------------------------------------------------------------------- *
*001 |20/12/2016|  ENJ  |SSDK900000| Implementação Inicial             *
************************************************************************
